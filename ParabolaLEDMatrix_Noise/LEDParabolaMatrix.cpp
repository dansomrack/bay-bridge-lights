...
cLEDMatrixBase::cLEDMatrixBase(int16_t tMWidth, int16_t tMMaxHeight) : FastLED_GFX(tMWidth,tMMaxHeight) { }
...
{
  if ( (x >= 0) && (x < m_Width) && (y >= 0) && (y >= m_MaxHeight - m_Heights[x]))
...
void cLEDMatrixBase::drawPixel(int16_t x0, int16_t y0, CRGB Col)
{
    (*this)(x0, y0) = Col;    
}
